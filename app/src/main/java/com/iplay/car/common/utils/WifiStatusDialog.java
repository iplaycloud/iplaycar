...
public class WifiStatusDialog extends Dialog {
	...
	private WifiStatusDialog(Context context, String wifiName,
	...
	public WifiStatusDialog(Context context,ScanResult scanResult,
			OnNetworkChangeListener onNetworkChangeListener) {
		this(context, scanResult.SSID, scanResult.level,
	...
	private void initView() {
		...
		txtConnStatus.setText(R.string.have_connect);
