...
public class WifiConnDialog extends Dialog {
	...
	public WifiConnDialog(Context context) {
		super(context);
	}

	private WifiConnDialog(Context context, String wifiName,
	...
	public WifiConnDialog(Context context, ScanResult scanResult,
